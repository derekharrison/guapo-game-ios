...
class StartMenu: SKScene {
    ...
    override func didMove(to _: SKView) {
        ...
        placeButton(scene: self, fac: 0.6, buttonNotPressed: playerMenuNotPressed, buttonPressed: playerMenuPressed)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with _: UIEvent?) {
        for touch: AnyObject in touches {
            ...
            pressedButton(pointOfTouch: pointOfTouch, buttonNotPressed : playerMenuNotPressed, buttonPressed : playerMenuPressed, pressed : &playerMenu)
